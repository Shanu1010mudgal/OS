...
def screenEntry():
    ...
    print( '\t'+line_c+'/\/\\               '+tag_c+'<Date>'+default_c+'  10/2022 '+tag_c+'</Date>                '+line_c+'/\/\\')
    print( '\t'+line_c+'\/\/'+default_c+'                                                      '+line_c+'\/\/')
    print( '\t'+line_c+'/\/\\      '+tag_c+'<Developer>'+default_c+' Saif Ali '+tag_c+'</Developer>      '+line_c+'/\/\\')
    print( '\t'+line_c+'\/\/   '+tag_c+'<Email>'+default_c+'  md.77292@mygyanvihar.com '+tag_c+'</Email>    '+line_c+'\/\/')
    print( '\t'+line_c+'/\/\\'+default_c+'                                                      '+line_c+'/\/\\')
    print( '\t'+line_c+'\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/')
    print( '\t'+line_c+'/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\\')
    print('')
